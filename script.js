...
fetchBtn.addEventListener('click', () => {
    ...
    setTimeout(() => {
        ...
        var url = `https://ipinfo.io/${IP}/geo?token=f7dc6377e3872c`;
    ...
    setTimeout(() => {
        alert("Please Open the Link Web Browser Else It will Not Fetch the Data from API & Please turn off all Ad blocker and Extension.");
    }, 2000);
})

//to retrive postal details
function post(pin){
...
//insert the API details in the card
